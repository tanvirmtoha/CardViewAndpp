...
public class AkademicCalender extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_akademic_calender);
        ...
        //pdf
        academic = findViewById(R.id.academicPdfId);

        academic.fromAsset("academic.pdf").load();
